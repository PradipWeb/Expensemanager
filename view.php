...
<!--Header -->
    ...
    <div class="row">
        ...
        <div class="col-sm-6">
         <form method="POST" action="expensedistribution.php">
         

           <button type="submit" class="btn btn-default btn-block" value=”registration_submit”>Expense Distribution</button>
             </div>      
 <br>
